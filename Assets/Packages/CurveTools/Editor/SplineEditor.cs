    	...
    	public override void OnInspectorGUI() {
    		...
    		if (GUILayout.Button("Add")) {
    			...
    			if (0 <= _iSelectedCP && _iSelectedCP < cps.Length)
					CurveTools.ArrayUtil.Insert(ref cps, newCP, _iSelectedCP + 1);
    			else
					CurveTools.ArrayUtil.Insert(ref cps, newCP, cps.Length);
    			curve.cps = cps;
    			_iSelectedCP++;
    		...
    		if (GUILayout.Button("Remove")) {
    			if (0 <= _iSelectedCP && _iSelectedCP < cps.Length) {
					CurveTools.ArrayUtil.Remove(ref cps, _iSelectedCP);
    			}
    			curve.cps = cps;
    			_iSelectedCP--;
    			EditorUtility.SetDirty(curve);
